...
> **Welcome to Service-Track Week 12, Task 4!**
...
| `src/alertingEngine.py` | Main source code - **has bugs to fix** |
| `src/metricsCollector.py` | Supporting code - **may also have bugs** |
| `tests/test_alerts.py` | Test file - **add your tests here** |
...
### Incident - `src/alertingEngine.py`
**User Report / Alert:**
> "Threshold is 9 instead of 90 (typo — missing a zero)"
...
### Incident - `src/alertingEngine.py`
**User Report / Alert:**
> "Checks free_memory_percent instead of used_memory_percent"
...
### Incident - `src/alertingEngine.py`
**User Report / Alert:**
> "Uses total error count instead of per-minute rate"
